...
class DataTransformationConfig:
    ...
    transformation_train_file_path: str = os.path.join(data_transform_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
                                                      TRAIN_FILE_NAME.replace('csv','npy'))
    
    transformation_test_file_path: str = os.path.join(data_transform_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
                                                      TEST_FILE_NAME.replace('csv','npy'))
    transformed_object_file_path: str = os.path.join(data_transform_dir,
...
@dataclass
class MentalHealthPredictorConfig:
